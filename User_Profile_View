...
import com.example.user_p.Progress.LoadingProgress;
...
public class ProfileView extends AppCompatActivity {
    ...
    TextView name, email, gameid, level, points;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameid = findViewById(R.id.ProfileView_user);
        level = findViewById(R.id.ProfileView_pass);
        points = findViewById(R.id.ProfileView_userType);
        ...
        dbf.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.hasChildren()){
                    ...
                    gameid.setText(snapshot.child("Game ID").getValue().toString());
                    level.setText(snapshot.child("Game Level").getValue().toString());
        ...
        btnProfilePicUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (profileImage != null){
                    ...
                    Toast.makeText(getApplicationContext(), "Profile Picture Has Not Been updated", Toast.LENGTH_SHORT).show();
                }
            }
        });
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        dbf.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                Toast.makeText(context, "Account Has Been Deleted Successfully", Toast.LENGTH_SHORT).show();
